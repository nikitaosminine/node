...
export const POLITICAL_NOMINATION_RE =
  /\b(?:president(?:ial)?|vice[- ]president|governor|senator|senate|congress(?:ional)?|representative|mayor|democrat(?:ic)?|republican|gop|libertarian|green party|party)\b[^\n?]{0,80}\b(?:nominee|nomination|primary|primaries)\b|\b(?:nominee|nomination|primary|primaries)\b[^\n?]{0,80}\b(?:president(?:ial)?|vice[- ]president|governor|senator|senate|congress(?:ional)?|representative|mayor|democrat(?:ic)?|republican|gop|libertarian|green party|party)\b/i;
