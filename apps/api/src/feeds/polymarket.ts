...
export const POLITICAL_NOMINATION_RE =
  /\b(?:who|which candidate|will)\b[^\n?]{0,100}\b(?:win|wins|be|become|be named|secure|capture)\b[^\n?]{0,100}\b(?:nominee|nomination|primary|primaries)\b|\b(?:nominee|nomination|primary|primaries)\b[^\n?]{0,100}\b(?:win|wins|become|be named|secure|capture)\b[^\n?]{0,100}\b(?:president(?:ial)?|vice[- ]president|governor|senator|senate|congress(?:ional)?|representative|mayor|democrat(?:ic)?|republican|gop|libertarian|green party|party)\b/i;
